...
func (c *companyServiceClient) ReplenishmentCompany(ctx context.Context, in *ReplenishmentRequest, opts ...grpc.CallOption) (*ReplenishmentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/company.CompanyService/ReplenishmentCompany", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *companyServiceClient) GetCompanyBalance(ctx context.Context, in *Id, opts ...grpc.CallOption) (*CompanyBalance, error) {
	...
	err := c.cc.Invoke(ctx, "/company.CompanyService/GetCompanyBalance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *companyServiceClient) GetTransactionHistory(ctx context.Context, in *TransactionHistoryRequest, opts ...grpc.CallOption) (*TransactionHistoryRes, error) {
	...
	err := c.cc.Invoke(ctx, "/company.CompanyService/GetTransactionHistory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *companyServiceClient) SendSMS(ctx context.Context, in *SmsRequest, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/company.CompanyService/SendSMS", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CompanyService_ReplenishmentCompany_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/company.CompanyService/ReplenishmentCompany",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CompanyService_GetCompanyBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/company.CompanyService/GetCompanyBalance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CompanyService_GetTransactionHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/company.CompanyService/GetTransactionHistory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CompanyService_SendSMS_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/company.CompanyService/SendSMS",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
