...
func file_debts_debt_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_debts_debt_proto_msgTypes[22].Exporter = func(v any, i int) any {
		...
		file_debts_debt_proto_msgTypes[23].Exporter = func(v any, i int) any {
			switch v := v.(*Client); i {
			case 0:
				return &v.state
			case 1:
		...
		file_debts_debt_proto_msgTypes[24].Exporter = func(v any, i int) any {
		...
		file_debts_debt_proto_msgTypes[25].Exporter = func(v any, i int) any {
			switch v := v.(*Error); i {
			case 0:
				return &v.state
			case 1:
