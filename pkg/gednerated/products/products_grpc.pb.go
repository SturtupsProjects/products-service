...
type ProductsClient interface {
	...
	GetListCategory(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CategoryList, error)
	// ------------- Products ---------------------------------------
...
func (c *productsClient) GetListCategory(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CategoryList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ProductsServer interface {
	...
	GetListCategory(context.Context, *emptypb.Empty) (*CategoryList, error)
	// ------------- Products ---------------------------------------
...
func (UnimplementedProductsServer) GetListCategory(context.Context, *emptypb.Empty) (*CategoryList, error) {
...
func _Products_GetListCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductsServer).GetListCategory(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
